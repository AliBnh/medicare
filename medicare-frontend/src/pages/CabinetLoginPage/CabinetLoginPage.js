...
function CabinetLoginPage() {
  ...
  function loginClinic() {
    ...
    axios
      .post("http://localhost:3002/loginToClinic", {
        code: code,
        password: password,
      })
    ...
    <div className="backdrop-blur-none	 bg-login-color transition duration-500 ease-in-out w-screen h-screen flex justify-center items-center">
      <div className=" flex w-full h-full sm:h-full flex-row transition duration-500 ease-in-out sm:flex-col  justify-center items-center  bg-login-color p-5 sm:p-2 ">
        <div className="flex-1 flex justify-center items-center ">
          <img
            className="w-full h-auto max-w-xl sm:max-w-md"
            src={docsImage}
            alt="Doctor"
          />
        </div>
        <div className="flex flex-1 max-w-xl rounded-xl bg-white items-center justify-center flex-col p-5 lg:p-2 mx-4  my-0">
          <div className="w-8/12 flex items-center justify-center my-9 text-gray-600 text-wrap">
          ...
          <div className="w-4/5 flex flex-col items-center justify-center gap-5">
            ...
            <div class="flex w-full items-center justify-start">
              <label
                class="relative flex items-center mr-1 rounded-full cursor-pointer"
                htmlFor="check"
              >
                <input
                  type="checkbox"
            ...
            <button
              onClick={loginClinic}
              className="mt-3 mb-6 w-full h-12 text-xl font-medium text-center text-white rounded-md border border-solid border-submit-color bg-submit-color transition duration-500 ease-in-out hover:text-black hover:border-login-color hover:bg-login-color"
            >
              Se connecter
            </button>
          </div>
