...
function DoctorConsultation() {
  ...
  const handleDownloadConsultationDB = async () => {
    const opt = {
      margin: 0.5,
      filename: `${
        new Date().toISOString().split("T")[0]
            ...
            <div className="grid grid-cols-1 gap-4 mt-4 mx-8 pb-6">
              ...
              <div className="grid grid-cols-3 gap-4 mt-4">
                <div className="flex flex-col">
                  <label className="text-gray-700 text-left mr-3">
                    Diabète :
                  </label>
                  <select
                    label="Diabète"
                    ...
                    className="flex-grow border-gray-200  border-2 rounded-md h-8"
                  >
                ...
                <div className="flex flex-col">
                  <label className="text-gray-700 text-left mr-3">HTA:</label>
                  <select
                    label="HTA"
                    value={hta}
                ...
                <div className="flex flex-col">
                  <label className="text-gray-700 text-left mr-3">Tabac:</label>
                  <select
                    label="Tabac"
                    value={tabac}
