            ...
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-2">
              <div className="lg:col-span-2">
                <div className="grid gap-4 gap-y-2 text-sm grid-cols-2 sm:grid-cols-1">
                  <div className="">
                    <label className="flex" htmlFor="code-cabinet">
                      Code du cabinet
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="">
                    <label className="flex" htmlFor="mdp-cabinet">
                      Mot de passe du cabinet
                    </label>
                    <input
                      type="password"
                      name="mdp-cabinet"
                      ...
                      placeholder="********"
                      value={mdpCabinet}
                      onChange={(e) => setMdpCabinet(e.target.value)}
                    />
                  </div>
                  <div className="">
                    <label className="flex" htmlFor="mail-cabinet">
                      Adresse mail
                    </label>
                    <input
                      type="text"
                      ...
                      placeholder=""
                      value={mailCabinet}
                      onChange={(e) => setMailCabinet(e.target.value)}
                    />
                  </div>
                  <div className="">
                    <label className="flex" htmlFor="ville-cabinet">
                      Ville
                    </label>
                    <input
                      type="text"
                  ...
                  <div className="">
                    <label className="flex" htmlFor="zipcode-cabinet">
                      Code postal
                    </label>
                    <input
                      type="text"
                      name="zipcode-cabinet"
                      id="zipcode-cabinet"
                      className="transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                      placeholder=""
                      value={zipcodeCabinet}
                      onChange={(e) => setZipcodeCabinet(e.target.value)}
                    />
                  </div>
                  <div className="">
                    <label className="flex" htmlFor="adresse-cabinet">
                      Adresse
                    </label>
                    <input
                      type="mail"
                      name="adresse-cabinet"
                      id="adresse-cabinet"
                      className="h-10 border mt-1 rounded px-4 w-full bg-gray-50"
                      placeholder=""
                  ...
                  <div className="">
                    <label className="flex" htmlFor="phone-cabinet">
                      Numéro de téléphone
                    </label>
                    <input
                      type="text"
                  ...
                  <div>
                    <label className="flex" htmlFor="logo-cabinet">
                      Logo du cabinet
                    </label>
                    <input
                      type="file"
                      ...
                      className="border rounded-md w-full mt-1 file:h-10 text-sm text-slate-500
                            ...
                            bg-gray-50"
                      value={logoCabinet}
                      onChange={(e) => setLogoCabinet(e.target.value)}
                    />
                  </div>
                  <div className="">
                    <label className="flex" htmlFor="mail-admin">
                      Adresse mail Admin
                    </label>
                    <input
                      type="mail"
                      ...
                      placeholder=""
                      value={mailAdmin}
                      onChange={(e) => setMailAdmin(e.target.value)}
                    />
                  </div>
                  <div className="">
                    <label className="flex" htmlFor="mdp-admin">
                      Mot de passe Admin
                    </label>
                    <input
                      type="password"
